...
export default function DisclaimerPage() {
  return (
    <PublicLayout title="Disclaimer">
      ...
      <section><h2 className="text-xl font-semibold mb-3">Memory Compression</h2>
        <p className="text-muted-foreground">The memory compression feature summarizes older context to reduce tokens. Some details may be simplified. The status bar in your chat shows when compression has occurred.</p></section>
