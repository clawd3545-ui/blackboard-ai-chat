    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-background to-muted p-4">
      <div className="w-full max-w-md">
        ...
        <div className="mt-8 grid grid-cols-3 gap-4 text-center">
          <div className="p-4 rounded-lg bg-card border"><div className="text-2xl font-bold text-primary">🔒</div><p className="text-xs text-muted-foreground mt-1">Encrypted Keys</p></div>
          <div className="p-4 rounded-lg bg-card border"><div className="text-2xl font-bold text-primary">🧠</div><p className="text-xs text-muted-foreground mt-1">Smart Context</p></div>
          <div className="p-4 rounded-lg bg-card border"><div className="text-2xl font-bold text-primary">⚡</div><p className="text-xs text-muted-foreground mt-1">Streaming</p></div>
        </div>
      </div>
    </div>
  );
